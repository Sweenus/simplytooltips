...
public class ThemeStudioScreen extends Screen {
    ...
    /**
     * All of the panel chrome. On 1.20.1 {@code Screen.render} does not paint a background at all,
     * so {@code renderBackground} is called explicitly from {@link #render} and there is no menu
     * blur to draw around — the reason master overrides {@code renderBackground} does not apply.
     */
    private void drawChrome(DrawContext context, int mouseX, int mouseY) {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        drawChrome(context, mouseX, mouseY);
